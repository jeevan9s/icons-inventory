...
export default function Navbar({ pageType }: navbarProps) {
  ...
  return (
    <div className="flex justify-between items-center px-3 sm:px-6 py-2 sm:py-4 h-auto sm:h-18 md:h-22 lg:h-24 relative z-50 bg-neutral-100 sticky top-0" suppressHydrationWarning>
      ...
      <div className="hidden absolute left-1/2 -translate-x-1/2 mx-auto sm:flex items-center p-1.5 bg-zinc-800 rounded-full shadow-lg border border-white/5 z-50">
