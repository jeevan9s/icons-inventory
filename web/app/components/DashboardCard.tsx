  ...
  return (
    ...
    >
      <div className="flex justify-between items-start">
        <span className="text-[10px] font-bold uppercase text-neutral-400 tracking-tight">
          {status}
        </span>
      ...
      <div className="flex flex-col gap-1">
        <h4 className="text-[14px] font-semibold text-neutral-900 leading-tight line-clamp-2 group-hover:text-black">
        ...
        {studentName ? (
          <>
            <p className="text-[10px] text-neutral-400 truncate">
              Signee: <span className="text-neutral-600 font-medium">{formatCapitalized(subtitle)}</span>
            </p>
            <p className="text-[10px] text-neutral-400 truncate">
              Student: <span className="text-neutral-600 font-medium">{formatCapitalized(studentName)}</span>
            </p>
          </>
        ) : (
