        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
          <div>
            ...
            <p className="text-xs text-neutral-500 mt-0.5">
              Manage and track equipment loans{" "}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={AddOpen}
              className="flex items-center gap-1.5 px-4 py-2 bg-neutral-900 text-white text-[11px] rounded-lg hover:bg-neutral-800 transition-all font-medium hover:cursor-pointer shadow-sm active:scale-95"
            >
